...
struct ItemView: View {
  //binding for realtime updating price in the main view
    @Binding var item: Item
    @Binding var items: [Item]
    
    var body: some View {
        ZStack{
            LinearGradient(gradient: .init(colors: [Color("lighblue"), Color("blue")]), startPoint: .leading,  endPoint: .trailing)
